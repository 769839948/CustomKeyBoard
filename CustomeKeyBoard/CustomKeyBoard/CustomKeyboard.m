...
- (void)setUpTapView:(CGRect)frame
{
    ...
    [tapView setBackgroundColor:[UIColor brownColor]];
...
- (void)showAnimation
{
    ...
    anima.toValue=[NSValue valueWithCGPoint:CGPointMake(UIScreenSize.width/2, UIScreenSize.height/2+60)];
...
- (void)hidderAnimation
{
    ...
    anima.keyPath=@"position";
    //设置通过动画，将layer从哪儿移动到哪儿
    anima.fromValue=[NSValue valueWithCGPoint:CGPointMake(UIScreenSize.width/2, UIScreenSize.height/2+60)];
